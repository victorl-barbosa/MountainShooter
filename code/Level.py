...
class Level:
    def __init__(self, window: Surface, name: str, game_mode: str, player_score: list[int]):
        self.timeout = TIMEOUT_LEVEL if name != 'Level3' else TIMEOUT_LEVEL * 2  # Duração diferenciada do Level 3
        self.window = window
        self.name = name
        ...
        while True:
            ...
            for event in pygame.event.get():
                ...
                if event.type == EVENT_ENEMY:
                    if self.name == 'Level3':  # Geração exclusiva de Enemy3 no Level 3
